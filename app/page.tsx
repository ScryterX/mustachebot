...
const HomePage = () => {
  ...
  return (
    <>
      ...
      <div className="flex min-h-screen flex-col bg-gray-100 py-2">
        <header className="w-full bg-white p-6 shadow-md">
          <h1 className="text-center text-4xl font-bold">Mustache Barbearia</h1>
        </header>
        ...
        <main className="flex flex-1 flex-col items-center justify-center px-4 py-6">
          <div className="mx-auto flex max-w-5xl flex-wrap justify-center gap-6">
            <Card className="w-80 bg-white shadow-lg">
              ...
              <CardContent>
                <p className="text-gray-700">
                  Oferecemos uma variedade de serviços de barbearia para você.
                </p>
              </CardContent>
              <CardFooter>
                <Link href="/chat">
            ...
            <Card className="w-80 bg-white shadow-lg">
              ...
              <CardContent>
                <p className="text-gray-700">
                  Agende seu horário com facilidade e rapidez.
                </p>
              </CardContent>
              <CardFooter>
                <Link href="/chat">
        ...
        <footer className="w-full bg-white p-4 shadow-inner">
          <p className="text-center text-gray-700">
            © 2024 Mustache Barbearia. Todos os direitos reservados.
          </p>
        </footer>
      </div>
    </>
